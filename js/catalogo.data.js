/**
 * Respaldo embebido del catálogo (misma estructura que catalogo.json).
 * Se usa si fetch de catalogo.json falla en algún dispositivo o servidor.
 * Mantén este archivo sincronizado con catalogo.json al editar equipos.
 */
export default {
  categorias: [
    {
